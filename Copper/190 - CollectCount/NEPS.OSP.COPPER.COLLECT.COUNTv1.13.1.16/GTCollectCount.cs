...
{
    class GTCollectCount : Intergraph.GTechnology.Interfaces.IGTCustomCommandModeless
    {
        #region CollectCount : Variables declaration
        ...
        public static frmCollectCount m_CustomForm = null;

        private static double detail_ID;
        #endregion

        #region CollectCount : Event Handlers
        ...
        void m_oIGTCustomCommandHelper_KeyDown(object sender, GTKeyEventArgs e)
        {
            ...
            if (e.KeyCode == 121)
            {
                DialogResult retVal = MessageBox.Show("Are you sure to finish CollectCount?", "CollectCount", MessageBoxButtons.YesNo);
        ...
        #region CollectCount : IGTCustomCommandModeless Members
        public void Activate(Intergraph.GTechnology.API.IGTCustomCommandHelper CustomCommandHelper)
        {
            ...
            SubscribeEvents();
            m_CustomForm = new frmCollectCount();
        ...
        private void Label_Click()
        {
            ...
            if (tempLabel.mobjEditServiceTemp != null)
                ...
                else
                {
                    ...
                    m_CustomForm.placeLabelMsg();
                }
        }

        private void Label_Move(GTMouseEventArgs e)
        {
            if (tempLabel != null)
            {
                if (tempLabel.FlagMove)
