...
{
    class GTTransferDelete : Intergraph.GTechnology.Interfaces.IGTCustomCommandModeless
    {
        ...
        // for General
        public static frmTransferDelete m_CustomForm = null;
        ...
        public void Activate(Intergraph.GTechnology.API.IGTCustomCommandHelper CustomCommandHelper)
        {
            ...
            SubscribeEvents();
            m_CustomForm = new frmTransferDelete();
