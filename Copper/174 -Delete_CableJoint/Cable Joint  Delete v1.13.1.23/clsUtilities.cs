...
class myUtil
{
    ...
    private string rsField(ADODB.Recordset rs, string fieldname)
    {
        try
        {
    ...
    private static void CopyFields(IGTKeyObject f, ADODB.Recordset rs, short iCNO, string fieldname)
    {
        try
        {
