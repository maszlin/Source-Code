...
{
    /// <summary>
    /// This Class logs messages to the file %TEMP%\SchematicLoopCustomCommand.log only if it exists.
    ...
    public class Logger
    {
        ...
        public static Logger getInstance()
        {
             ...
             * the next time, but with the log file closed (the log file is closed on SchematicLoop.ExitCmd()) thus generating
             * an error.
             */ 
        ...
        private void OpenFile()
        {
            ...
            fileExists = File.Exists(tempDir + "\\LandedToPropertyCustomCommand.log");

            if (fileExists)
            {
                logFile = File.CreateText(tempDir + "\\LandedToPropertyCustomCommand.log");
                fileOpen = true;
            }
