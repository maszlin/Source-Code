...
{
    class GTCabinet : Intergraph.GTechnology.Interfaces.IGTCustomCommandModeless
    {
        ...
        GTCabinetForm m_CustomForm = null;
        ...
        {
            application.SetStatusBarText(GTStatusPanelConstants.gtaspcMessage, "Running .NET custom modeless command...");            
            ...
            SubscribeEvents();
            m_CustomForm = new GTCabinetForm();
