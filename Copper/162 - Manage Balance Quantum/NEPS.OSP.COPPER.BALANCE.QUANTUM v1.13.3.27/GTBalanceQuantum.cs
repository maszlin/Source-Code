...
{
    class GTBalanceQuantum : Intergraph.GTechnology.Interfaces.IGTCustomCommandModeless
    {
        ...
        public static frmBalanceQuantum m_CustomForm = null;
        ...
        public void Activate(Intergraph.GTechnology.API.IGTCustomCommandHelper CustomCommandHelper)
        {
            ...
            SubscribeEvents();
            m_CustomForm = new frmBalanceQuantum();
