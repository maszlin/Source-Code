                ...
                if ((iCNO == 7001) || (iCNO == 51))
                {
                    if (!fromFeature.Components[i].Recordset.EOF)
                    {
                        ...
                        for (int j = 0; j < fromFeature.Components[i].Recordset.Fields.Count; j++)
                        {
                            ...
                            if (fromFeature.Components[i].Recordset.Fields[j].Name == "MIN_MATERIAL")
                            {
                                try
                                {
                                    string[] mm = fromFeature.Components[i].Recordset.Fields[j].Value.ToString().Split('|');

                                    if (mm.Length == 4)
                                    {
                                        if (fromFeature.FNO == 10800)
                                        {
                                            break;
                                            toFeature.Components.GetComponent(51).Recordset.Update("MIN_MATERIAL", mm[1] + "|" + mm[2] + "|" + mm[3] + "|" + "FF");
                                            toFeature.Components.GetComponent(7001).Recordset.Update("CTYPE", mm[1]);
                                            toFeature.Components.GetComponent(7001).Recordset.Update("TOTAL_SIZE", mm[2]);
                                            toFeature.Components.GetComponent(7001).Recordset.Update("GAUGE", mm[3]);
                                        }
                                        else if (fromFeature.FNO == 7000)
                                        {
                                            toFeature.Components.GetComponent(51).Recordset.Update("MIN_MATERIAL", mm[0] + "|" + mm[1] + "|" + mm[2] + "|" + mm[3]);
                                            toFeature.Components.GetComponent(7001).Recordset.Update("CTYPE", mm[0]);
                                            toFeature.Components.GetComponent(7001).Recordset.Update("TOTAL_SIZE", mm[1]);
                                            toFeature.Components.GetComponent(7001).Recordset.Update("GAUGE", mm[2]);
                                        }
                                    }
                                }
                                catch { }
                            }
                            else if ((fromFeature.Components[i].Recordset.Fields[j].Name != "G3E_FID") &&
                                        ...
                                        (fromFeature.Components[i].Recordset.Fields[j].Name != "FEATURE_STATE") &&
                                        (fromFeature.Components[i].Recordset.Fields[j].Name != "JOB_ID")
                                    )
