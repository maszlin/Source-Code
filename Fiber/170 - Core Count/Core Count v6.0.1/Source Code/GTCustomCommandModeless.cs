...
namespace NEPS.GTechnology.CoreCount
{
    ...
    class GTCustomCommandModeless : Intergraph.GTechnology.Interfaces.IGTCustomCommandModeless
    {
        ...
        GTWindowsForm_CoreCount m_CustomForm = null;
        ...
        {
            GTClassFactory.Create<IGTApplication>().SetStatusBarText(GTStatusPanelConstants.gtaspcMessage, "Select another device, then click reload device for core count assignment...");
        ...
        public void Activate(Intergraph.GTechnology.API.IGTCustomCommandHelper CustomCommandHelper)
        {
            ...
            SubscribeEvents();
            m_CustomForm = new GTWindowsForm_CoreCount();
            ...
            if (GTClassFactory.Create<IGTApplication>().DataContext.ActiveJob == null)
            {
                MessageBox.Show("No Transaction Manager", "Error.", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                m_CustomForm.Show();
        ...
        //public void Activate(Intergraph.GTechnology.API.GTCustomCommandHelper CustomCommandHelper)
        //{
        //    GTClassFactory.Create<IGTApplication>().SetStatusBarText(GTStatusPanelConstants.gtaspcMessage, "Running .NET custom modeless command...");            
        //    m_oGTCustomCommandHelper = CustomCommandHelper;           
