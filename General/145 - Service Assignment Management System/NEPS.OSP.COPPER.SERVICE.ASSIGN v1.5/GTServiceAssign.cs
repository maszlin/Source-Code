...
{
    class GTServiceAssign : Intergraph.GTechnology.Interfaces.IGTCustomCommandModeless
    {
        ...
        public static frmServiceAssign m_CustomForm = null;
        public static clsServicePoint m_Service = new clsServicePoint();
        ...
        void m_oIGTCustomCommandHelper_Activate(object sender, GTActivateEventArgs e)
        {
            ...
            //        if (e.MapWindow.DetailID.ToString() == "0")
            //        {
            //            //m_CustomForm.XPointGeom = 0;
            //            //m_CustomForm.YPointGeom = 0;
            //        }
            //    }
            //}
            //catch (Exception e1)
        ...
        public void Activate(Intergraph.GTechnology.API.IGTCustomCommandHelper CustomCommandHelper)
        {
            ...
            SubscribeEvents();
            m_CustomForm = new frmServiceAssign();
