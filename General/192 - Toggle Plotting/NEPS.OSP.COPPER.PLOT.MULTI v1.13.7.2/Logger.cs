    ...
    public class Logger
    {
        ...
        public void OpenFile(string filename)
        {
           ...
           // string tempDir = "E:\\Temp";
            ...
            logFile = File.CreateText(tempDir + "\\" + filename);
            fileOpen = true;
            fileExists = File.Exists(tempDir + "\\" + filename);


            //fileExists = File.Exists(tempDir + "\\Service_Boundry.log");

            //if (fileExists == false)
            //{
            //    logFile = File.CreateText(tempDir + "\\Service_Boundry.log");
            //    fileExists = true;
            //    fileOpen = true;
            //}
