...
namespace NEPS.GTechnology.BulkMoveFeatures
{
    class PlacementBase : IGTCustomCommandModeless
    {
        ...
        private EventHandler<GTMouseEventArgs> EV_CommandHelper_MouseDblClick;
        ...
        public void Activate(IGTCustomCommandHelper CustomCommandHelper)
        {
            ...
            EV_CommandHelper_MouseDblClick = new EventHandler<GTMouseEventArgs>(CommandHelper_MouseDblClick);
            ...
            CustomCommandHelper.DblClick += EV_CommandHelper_MouseDblClick;
        ...
        void CommandHelper_MouseDblClick(object sender, GTMouseEventArgs e)
        {
            OnMouseDblClick(e);
        }
        ...
        protected IGTKeyObject GetPreselectedFeature()
        {
            IGTKeyObject selectedFeature = null;
            foreach (IGTDDCKeyObject selectedObj in app.SelectedObjects.GetObjects())
            {
        ...
        private void CleanUp()
        {
            ...
            commandHelper.DblClick -= EV_CommandHelper_MouseDblClick;
        ...
        protected virtual void OnMouseDblClick(GTMouseEventArgs args)
        {
