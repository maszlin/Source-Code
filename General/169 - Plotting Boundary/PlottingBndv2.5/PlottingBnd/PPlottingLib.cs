...
namespace AG.GTechnology.Utilities
{
    ...
    public class PPlottingLib
    {
        ...
        public static int mMISX_Pnt = 0;
        public static int mMISY_Pnt = 0;
                ...
                {
                    {
                        ...
                        mMISX_Pnt = oPlotBoundary.SheetInset;
                        mMISY_Pnt = oPlotBoundary.SheetHeigh - oPlotBoundary.SheetInset;
                    }
                }
                else
                {
