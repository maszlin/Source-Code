...
namespace AG.GTechnology.Utilities
{
    ...
    class PPlottingLib
    {
        ...
        private static void PopulateRedlineGroupInfo(ref ADODB.Recordset rsRedlines, ref ADODB.Recordset rsGroupsDRI, PlotBoundary oPlotBoundary)
        {
            try
            {
                ...
                while (!rsRedlines.EOF)
                {
                    ...
                    switch (strDatatype)
                    {
                        ...
                        case GTRedlineGroupDataTypeConstants.gtrgdtRedlineText:
                            ...
                            {
                                strText = strText.Replace("[cr_by]", application.DataContext.DatabaseUserName);
                                strText = strText.Replace("[cr_by]", application.DataContext.DatabaseUserName);
                            }
        ...
        public static void ProcessDrawingInfoGroups(PlotBoundary oPlotBoundary)
        {
            ...
            while (!rsGroupsDRI.EOF)
            {
                ...
                {
                    PopulateRedlineGroupInfo(ref rsRedlines, ref rsGroupsDRI, oPlotBoundary);
                }
                rsRedlines = null;
        ...
        public static void StartDrawingRedlines(PlotBoundary oPlotBoundary)
        {
            ...
            try
            {
                ...
                // Generate redlines
                //
                ProcessDrawingInfoGroups(oPlotBoundary);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Plotting Boundary", MessageBoxButtons.OK, MessageBoxIcon.Error);
