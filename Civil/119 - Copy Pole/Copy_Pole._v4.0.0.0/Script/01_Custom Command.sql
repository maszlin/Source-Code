---Copy Pole CustomCommand
 ...
 Values
   (G3E_CUSTOMCOMMAND_SEQ.NEXTVAL, 'Copy Pole', 'Copy Pole', 'Anna Poe', 0, 0, 'Copy Pole', 4, 8388624, 0, 0, 1, SYSDATE, 'NEPSCopyCivilPole:NEPS.GTechnology.NEPSCopyPole.GTCopyCivilPole');
 COMMIT;