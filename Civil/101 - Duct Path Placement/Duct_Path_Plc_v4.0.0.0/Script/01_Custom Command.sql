  ---Duct Path Placement CustomCommand
 ...
 Values
   (G3E_CUSTOMCOMMAND_SEQ.NEXTVAL, 'Duct Path Placement', 'Duct Path Placement', 'Anna Poe', 0, 0, 'Duct Path Placement', 4, 8388624, 0, 0, 1, SYSDATE, 'NEPSDuctPathPlc:NEPS.GTechnology.NEPSDuctPathPlc.GTDuctPathPlc');
COMMIT;
