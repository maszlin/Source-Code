 ...
 Values
   (G3E_CUSTOMCOMMAND_SEQ.NEXTVAL, 'DuctNest Delete', 'DuctNest Delete', 'Anna Poe', 0, 0, 'DuctNest Delete', 4, 8388624, 0, 0, 1, SYSDATE, 'NEPSDuctNestDel:NEPS.GTechnology.NEPSDuctNestDel.GTDuctNestDel');
COMMIT;