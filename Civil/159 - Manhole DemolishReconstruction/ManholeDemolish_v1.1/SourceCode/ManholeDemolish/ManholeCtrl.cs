...
namespace AG.GTechnology.ManholeDemolish
{
    public partial class ManholeCtrl : UserControl
    {
        ...
        private IGTPoint _Arrow = null;
        public IGTPoint Arrow
        {
            set { _Arrow = value; }
            get { return _Arrow; }
        }
        ...
        public void LoadManholeType()
        {
            ...
            if (_oManhole == null) _oManhole = application.DataContext.OpenFeature(2700, _fid);
            _style = helper.GetComponentStyleID(_oManhole, 2720);
            _textstyle = helper.GetComponentStyleID(_oManhole, 2730);
            helper.GetComponentLabel(Manhole, 2730, ref _label, ref _labelAlignment);

            _Origin = _oManhole.Components.GetComponent(2720).Geometry.FirstPoint;
            _x = _Origin.X;
            _y = _Origin.Y;

            _angle = PGeoLib.GetOrientedPointAngle(_oManhole.Components.GetComponent(2720).Geometry);
