...
namespace NEPS.GTechnology.NEPSDuctPathExtension
{
	...
	public class MultiColumnComboPopup : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.lstvMyView.Size = new System.Drawing.Size(465, 147);
            ...
            this.lstvMyView.MouseUp += new System.Windows.Forms.MouseEventHandler(this.lstvMyView_MouseUp);
            ...
            this.MouseClick += new System.Windows.Forms.MouseEventHandler(this.MultiColumnComboPopup_MouseClick);
...
//		}
        ...
        private void lstvMyView_MouseUp(object sender, MouseEventArgs e)
        {
            //if (lstvMyView.SelectedItems.Count > 0)
            //{
            //    selectedRow = dataTable.Rows[lstvMyView.SelectedIndices[0]];
        ...
        private void MultiColumnComboPopup_MouseClick(object sender, MouseEventArgs e)
        {
            if (lstvMyView.SelectedItems.Count > 0)
            {
                selectedRow = dataTable.Rows[lstvMyView.SelectedIndices[0]];
