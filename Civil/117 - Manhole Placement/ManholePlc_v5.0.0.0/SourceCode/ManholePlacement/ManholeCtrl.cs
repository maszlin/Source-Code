...
namespace AG.GTechnology.ManholePlacement
{
    public partial class ManholeCtrl : UserControl
    {
        ...
        public void LoadManholeType()
        {
            ...
            //string sSql = "select b.MANHOLE_TYPE, b.STYLEID, b.TEMPSTYLEID from AG_MANHL b where b.MANHOLE_TYPE='" + _type + "'";
            ...
            //        if (rsComp.Fields["TEMPSTYLEID"].Value != DBNull.Value) _tempstyle = Convert.ToInt32(rsComp.Fields["TEMPSTYLEID"].Value);
